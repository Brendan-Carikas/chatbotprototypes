...
import MessageList from './MessageListCouncil';
import ChatInput from './ChatInputCouncil';
import FeedbackDrawer from './FeedbackDrawer';
import TypingIndicator from './TypingIndicator';
import { useChat, ChatProvider } from '../contexts/ChatContextCouncil';
...
const ChatSuggestionsCouncil: React.FC = () => {
  return (
...
export default ChatSuggestionsCouncil;
