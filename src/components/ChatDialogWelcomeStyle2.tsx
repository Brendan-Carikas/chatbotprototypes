...
import AuthenticationOverlay from './AuthenticationOverlayStyle2';
...
interface ChatDialogWelcomeStyle2Props {
  onClose: () => void;
}
...
const ChatDialogWelcomeStyle2: React.FC<ChatDialogWelcomeStyle2Props> = ({ onClose }) => {
...
export default ChatDialogWelcomeStyle2;
